  ...
  return (
    <aside className="right-sidebar">
        ...
        <div className="profile">
          <div className="profile-img">
            <span className="text-5xl font-bold text-blue-500">
              {user ? user.name[0] : "Guest"}
            </span>
            {/* this is for the profile picture */}
            {/* display the user's name but only the first character */}
          </div>
      ...
      <section className="banks">
        ...
        {/* if bank exist */}
        {banks?.length > 0 && (
          <div className="relative fle flex-1 flex-col items-center justify-center gap-5">
            ...
            {/* if there are more than 1 bank card, we will display another card */}
            {banks[1] && (
